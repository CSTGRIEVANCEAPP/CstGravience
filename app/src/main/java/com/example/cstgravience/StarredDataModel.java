...
public class StarredDataModel {
    ...
    String cuEmail,GrievanceTITLE,GrieveanceTEXT,StarredGrievanceID,date;

    StarredDataModel(){

    }

    public StarredDataModel(String cuEmail, String grievanceTITLE, String grieveanceTEXT, String starredGrievanceID, String date) {
